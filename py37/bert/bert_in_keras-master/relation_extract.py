...
with open("../datasets/train_data.json", encoding="utf-8", mode="r") as f1:
    train_data = f1.readlines()
# train_data = json.load(open('../datasets/train_data.json'))
with open("../datasets/dev_data.json", encoding="utf-8", mode="r") as f2:
    dev_data = f2.readlines()
# dev_data = json.load(open('../datasets/dev_data.json'))
predicate2id = {}
id2predicate = {}
line = 0
